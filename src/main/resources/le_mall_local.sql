...
# Dump of table le_mall_cart
# ------------------------------------------------------------

DROP TABLE IF EXISTS `le_mall_cart`;

CREATE TABLE `le_mall_cart` (
...
# Dump of table le_mall_category
# ------------------------------------------------------------

DROP TABLE IF EXISTS `le_mall_category`;

CREATE TABLE `le_mall_category` (
...
LOCK TABLES `le_mall_category` WRITE;
/*!40000 ALTER TABLE `le_mall_category` DISABLE KEYS */;

INSERT INTO `le_mall_category` (`id`, `name`, `type`, `parent_id`, `order_num`, `create_time`, `update_time`)
VALUES
...
/*!40000 ALTER TABLE `le_mall_category` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table le_mall_order
# ------------------------------------------------------------

DROP TABLE IF EXISTS `le_mall_order`;

CREATE TABLE `le_mall_order` (
...
# Dump of table le_mall_order_item
# ------------------------------------------------------------

DROP TABLE IF EXISTS `le_mall_order_item`;

CREATE TABLE `le_mall_order_item` (
  `id` int(64) NOT NULL AUTO_INCREMENT COMMENT '主键id',
...
# Dump of table le_mall_product
# ------------------------------------------------------------

DROP TABLE IF EXISTS `le_mall_product`;

CREATE TABLE `le_mall_product` (
...
LOCK TABLES `le_mall_product` WRITE;
/*!40000 ALTER TABLE `le_mall_product` DISABLE KEYS */;

INSERT INTO `le_mall_product` (`id`, `name`, `image`, `detail`, `category_id`, `price`, `stock`, `status`, `create_time`, `update_time`)
VALUES
...
/*!40000 ALTER TABLE `le_mall_product` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table le_mall_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `le_mall_user`;

CREATE TABLE `le_mall_user` (
...
LOCK TABLES `le_mall_user` WRITE;
/*!40000 ALTER TABLE `le_mall_user` DISABLE KEYS */;

INSERT INTO `le_mall_user` (`id`, `username`, `password`, `personalized_signature`, `role`, `create_time`, `update_time`)
VALUES
	...
	(14,'le','SMRMN9k6YmXAjbsJCMdxrQ==','',1,'2020-03-02 22:45:48','2020-03-02 22:45:48'),
	(15,'super2','SMRMN9k6YmXAjbsJCMdxrQ==','',1,'2020-03-07 18:09:47','2020-03-07 18:09:47');

/*!40000 ALTER TABLE `le_mall_user` ENABLE KEYS */;
UNLOCK TABLES;
